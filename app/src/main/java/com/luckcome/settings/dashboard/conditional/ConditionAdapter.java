...
import com.luckcome.settings.dashboard.DashboardAdapter;
import com.luckcome.settings.dashboard.DashboardData;
...
public class ConditionAdapter extends RecyclerView.Adapter<DashboardAdapter.DashboardItemHolder> {
    ...
    private @DashboardData.HeaderMode
    int mMode;
    ...
    public ConditionAdapter(Context context, List<Condition> conditions, @DashboardData.HeaderMode int mode) {
        mContext = context;
    ...
    public DashboardAdapter.DashboardItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new DashboardAdapter.DashboardItemHolder(LayoutInflater.from(parent.getContext()).inflate(
