...
import com.luckcome.settings.core.gateway.SettingsGateway;
import com.luckcome.settings.core.instrumentation.MetricsFeatureProvider;
import com.luckcome.settings.core.instrumentation.SharedPreferencesLogger;
import com.luckcome.settings.dashboard.DashboardFeatureProvider;
import com.luckcome.settings.dashboard.DashboardSummary;
import com.luckcome.settings.overlay.FeatureFactory;
import com.luckcome.settings.search.SearchActivity;
import com.luckcome.settings.widget.SwitchBar;
...
public class SettingsActivity extends SettingsDrawerActivity
    ...
    private void doUpdateTilesList() {
        ...
        somethingChanged = setTileEnabled(
                new ComponentName(packageName, Settings.WifiSettingsActivity.class.getName()),
